...
const raw = [
  {
    ...
    body:
      ...
      "004 0:42–1:07 四张论文卡（一文一图，首页标题区截屏，不扫正文）：① 一次有没有变化＝Laureate 2018 开放标签，五十人、单次后状态焦虑显著下降（禁止写成 RCT）；② 重复能不能做完＝同一实验室 2024 可行性 RCT，六次人能做完，无严重不良事件只作小字，没有功效主终点；③ 对照有没有功效＝Kjellgren 2014 BMC 随机对照试点，六十五人十二次，压力与焦虑指标下降（禁止写成治疗 GAD/抑郁）；④ 会不会很快没了＝柳叶子刊 2023 RCT，状态焦虑与身体意象、六个月仍有信号。收束：一次看见变化，重复做得完，对照有信号。禁止写成治疗厌食或我方适应症。\n" +
