...
const raw = [
  {
    ...
    body:
      ...
      "006 1:20–1:38 章末承接中式漂浮：国际关注疼痛与睡眠；现有国际设备多半停在放松体验，还没兑现快速缓痛和有效助眠（不是说国际没有疼痛文献）；中式漂浮扩大内涵、结合机理、技术升级，让缓痛和助眠成为可兑现的结果；中国漂浮行业专家教授与漂浮方舟正在收集研究数据。不要治疗失眠/慢性疼痛，不要点名氢光AI，不要把收集中的数据写成已完成 RCT。\n\n" +
