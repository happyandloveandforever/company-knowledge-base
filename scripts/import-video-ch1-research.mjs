...
const now = "2026-09-06T08:40:00.000Z";
...
const raw = [
  {
    ...
    summary:
      "第一章不要闪期刊封面、不要用机制占最长镜头。改成：方法谱系兑现六十年 → 四张可点名论文 → 2025 系统综述地图与限度 → 章末 006 承接中式漂浮（疼痛/睡眠关注、国际设备停在放松、扩大内涵并收集数据）。机制旁白挪到机理章。",
    body:
      ...
      "003 0:30–0:42 谱系三张指定图：① 1950s 隔离舱实验＝John C. Lilly 与早期箱式漂浮舱（不要写成 1954 某日现场）；② 1970–80s 被定名为 REST＝Suedfeld 1980 Wiley 专著把 REST 写进书名（不是开会起名仪式；1983 会议不写进封面字）；③ 2010s– 临床与影像＝漂浮中脑电与生理监测（静帧 003e-eeg-frame.jpg，或成片 003e-eeg-overlay.mp4：原研究视频叠中文说明；BR/γβθα 已在原片里不要再叠；不要写成 Feinstein 2018 或 2021 首次 fMRI）。底部：先有研究，后发展成疗法（不要写先有方法，后有舱）。旁白：Floatation-REST 不是近年体验概念，是二十世纪中叶实验室走出来的方法，已有六十余年研究积累。六十年=方法史，不是六十年临床试验。\n" +
      "004 0:42–1:07 四张论文卡（一文一图，首页标题区截屏，不扫正文）：① 一次有没有变化＝Laureate 2018 开放标签，五十人、单次后状态焦虑显著下降（禁止写成 RCT）；② 多次使用是否舒适安全＝同一实验室 2024，六次、七十五人全部完成、依从度很高，绿框写依从度高、使人舒适的安全疗法（画面不要写人能不能做完、不要写不是疗效金标准；仍不要把这篇写成疗效）；③ 用临床对照的标准看有没有功效＝Kjellgren 2014 BMC 随机对照试点，六十五人十二次，压力与焦虑指标下降（禁止写成治疗 GAD/抑郁）；④ 会不会很快没了＝柳叶子刊 2023 RCT，状态焦虑与身体意象、六个月仍有信号。旁白收束：一次看见变化，重复做得完，对照有信号。四宫格标题：一次有结果，多次也显著，完成疗程无不良，长期效果仍持续。底部：先有漂浮疗法，后有中式漂浮。禁止写成治疗厌食或我方适应症。\n" +
      ...
      "006 1:20–1:38 章末承接中式漂浮：国际关注疼痛与睡眠；现有国际设备多半停在放松体验（画面可列 i-sopod/Dreampod/Oasis 等常见商业舱名，旁白不要点名贬损单一品牌），还没兑现快速缓痛和有效助眠；中式漂浮扩大内涵、结合机理、技术升级；006c 先出静帧（用户视频首帧占位），再在同一框切进用户视频。专家教授与漂浮方舟正在收集研究数据。不要治疗失眠/慢性疼痛，不要点名氢光AI，不要把收集中的数据写成已完成 RCT。\n\n" +
    ...
    examples: [
      ...
      "对（2024 卡）：多次使用，是否舒适安全？六次，七十五人全部完成。依从度高，使人舒适的安全疗法",
      "对（006 承接）：国际上正关注疼痛和睡眠；现有设备停在放松体验；中式漂浮扩大内涵、沿机理升级；专家教授与方舟正在收集数据",
      "错：把 2024 写成疗效，或画面写「人能不能做完」「不是疗效金标准」",
      "错（006）：治疗失眠/治疗慢性疼痛，或把正在收集的数据写成已完成临床试验",
    ],
  },
];
