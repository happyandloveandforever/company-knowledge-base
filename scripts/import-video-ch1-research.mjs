...
const now = "2026-09-06T07:40:00.000Z";
...
const raw = [
  {
    ...
    summary:
      "第一章 50 秒不要闪期刊封面、不要用机制占最长镜头。改成：方法谱系兑现六十年 → 三次证据升级（一次变化/重复可完成/对照也有了）→ 2025 系统综述地图与限度。机制旁白挪到机理章。",
    body:
      ...
      "004 0:42–1:07 三次证据升级（先问题后结果，不要按参考文献念）：① 一次有没有变化＝Laureate 2018 开放标签，五十人、单次约一小时后状态焦虑显著下降（禁止写成 RCT）；② 重复能不能做完＝同一实验室 2024 可行性 RCT，六次做完、无严重不良事件，只证明能做完较安全；③ 对照有没有更硬证据＝柳叶子刊 2023 RCT，状态焦虑与身体意象、六个月仍有信号。收束：一次看见变化，重复做得完，对照也有了。禁止写成治疗厌食或我方适应症。\n" +
    ...
    examples: [
      "对：一次看见变化，重复做得完，对照也有了",
      "错：把三篇论文像参考文献一样念完，或期刊封面闪三下再用 25 秒讲浮力",
    ],
  },
];
