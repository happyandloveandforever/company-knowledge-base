/**
 * 专利库隔离回归：不进总库、不进 /open、四簇矩阵主题合并完整。
...
check("专利卡至少 23 条", patents.length >= 23, String(patents.length));
...
check("四簇结论卡齐全", ["PAT-CLU-001", "PAT-CLU-002", "PAT-CLU-003", "PAT-CLU-004"].every((id) => patents.some((p) => p.id === id)));
