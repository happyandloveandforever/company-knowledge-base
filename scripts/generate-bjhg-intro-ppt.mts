...
async function main() {
  ...
  const slides: OutlineSlide[] = [
    ...
    slide(
      ...
      ["KP-BG2-009", "KP-BG2-001", "KP-BG2-027", "KP-BG2-064"],
      "方案本质",
    ...
    slide(
      ...
      ["KP-BG2-033", "KP-BG2-034", "KP-BG2-040", "KP-BG2-041"],
      "证据与合规",
    ...
    slide(
      ...
      ["KP-CHAMP-001", "KP-CHAMP-007", "KP-BG2-048", "KP-BG2-051", "KP-BG2-055"],
      "方向对齐",
