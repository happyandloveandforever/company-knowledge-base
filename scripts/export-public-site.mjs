...
<nav>${nav}</nav>
<p class="stats">总库 ${points.length} 条已合并 · 可外发 ${external.length} 条 · 仅内训 ${points.length - external.length} 条（KP-TRN / KP-ATOM / KP-RX / 部分 KP-NSF）不进公开页</p>
