...
async function main() {
  ...
  const slides: OutlineSlide[] = [
    ...
    slide(
      ...
      ["KP-BG2-003", "KP-MECH-003", "KP-BRAND-001"],
      "深入浅出",
    ...
    slide(
      ...
      ["KP-BRAND-001", "KP-V7-001", "KP-FAF-001", "KP-BG2-064"],
      "定位辉煌",
    ...
    slide(
      ...
      ["KP-MECH-001", "KP-MECH-003", "KP-CHAMP-001"],
      "机理浅讲",
    ...
    slide(
      ...
      ["KP-WEB-010", "KP-WEB-002", "KP-WEB-003", "KP-BG2-040"],
      "学术辉煌",
    ...
    slide(
      ...
      ["KP-CHAMP-013", "KP-BRAND-031", "KP-CHAMP-003"],
      "信任辉煌",
    ...
    slide(
      ...
      ["KP-BRAND-022", "KP-BRAND-021", "KP-BRAND-031", "KP-BG2-073"],
      "生态辉煌",
    ...
    slide(
      ...
      ["KP-BRAND-032", "KP-CHAMP-022", "KP-BG2-073"],
      "规模辉煌",
    ...
    slide(
      ...
      ["KP-CHAMP-007", "KP-BG2-048", "KP-BG2-051", "KP-V7-003", "KP-CRAFT-027"],
      "契合升级",
      "这一页是对号入座，不是新发明四个产品。对方已经在看心理/主动健康、数字健康、企业精力、康养与园区载体。对北化生科口，01 可改成「抗衰与主动健康」，后半句不用改。不要在这一页展开迷走机制。"
    ),
    slide(
      13,
      "合作可以很大，入口可以很轻",
    ...
    slide(
      ...
      ["KP-BRAND-001", "KP-BG2-073", "KP-CHAMP-022"],
      "收束",
