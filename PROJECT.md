...
| **独立专利库 `PAT-*`** | **72** 条（全部 `internal`，不进 `/open`、不进编排）。**报告 v2.0**：去盐测试闸门 + 母案B收窄 + 取消20件硬指标 + 清水对照组要求；六簇与两母案结构不变；交底书撰写包 7 条；中外前案 25 条（含美国专利与 IEC 标准） |
...
| ⑤ **近饱和高盐液的配液精度** | E1 | 🟡 已降级，与 A1/A2/A5 重合 |
...
| 2026-09-04 | 三个绿灯角度补检索（68→72）：①打掉——泵阀故障检出路径已被 US7069183 等公开，且「环境安静所以更容易」不构成技术问题，据此给闸门追加「难题还是便宜」一问；③重新定位为「含气泡高盐液中声能测不准」（超声剂量标准要求脱气水测量，且不覆盖低频），升为最有希望；⑤降黄，从"密度旋钮"转向近饱和高盐液的配液精度。任务书已打掉清单同步 |
