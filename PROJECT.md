...
> **最后更新：** 2026-09-06（由 Agent 维护，每次入库后更新此节）

| 指标 | 数值 |
|------|------|
| 知识点总数 | **607**（589 `approved` + 18 `draft`） |
| 通识层 `commons` | **178** 条：公开科学/政策/卫生/证据边界 + 迷走/VNS 通识 + NSF 标准五问 + 罗森堡读本 27 条（1–200 合并 15 + 201–352 合并 12） |
| 公司自有层 `company` | **429** 条：产品、SOP、报价、案例、财务、内训教材、综合干预专业版、内部原子库、疗法叙事脊柱、罗森堡对接口径 |
| 用途 `usage` | `pitch` 304 · `training` 167 · `ops` 62 · `both` 74 |
| **仅内训 `internalOnly`** | **127** 条（`KP-TRN-*` 94 + `KP-ATOM-*` 20 + `KP-RX-*` 13），编排 PPT 默认排除 |
| 已导入文件 | **40** |
| 待 Claude 拆分队列 | 0 |
| 结构判断 | 两层已切开；内训 127 条；迷走三套 56 条已批准；罗森堡读本 **27 条**（001~015 为 1–200 主题合并；016~027 为 201–352 主题合并）；原子库零件箱 20 + 疗法五维脊柱 13；NSF 标准五问 8 条通识卡。仍缺锁数字与真实案例 |
...
| 迷走神經的自我檢測與治癒_201-240.pdf | SRC-PVB-ROSENBERG-201-240 | 已并入 KP-PVB-016 ~ 027 | — | done，已主题合并 | claude-agent |
| 迷走神經的自我檢測與治癒_241-280.pdf | SRC-PVB-ROSENBERG-241-280 | 已并入 KP-PVB-016 ~ 027 | — | done，已主题合并 | claude-agent |
| 迷走神經的自我檢測與治癒_281-320.pdf | SRC-PVB-ROSENBERG-281-320 | 已并入 KP-PVB-016 ~ 027 | — | done，已主题合并 | claude-agent |
| 迷走神經的自我檢測與治癒_321-352.pdf | SRC-PVB-ROSENBERG-321-352 | 已并入 KP-PVB-016 ~ 027 | — | done，已主题合并 | claude-agent |
| 罗森堡续拆主题合并 | SRC-PVB-ROSENBERG-CONT-MERGED | KP-PVB-016 ~ 027 | 12 | done，已批准 | claude-agent |
...
| 罗森堡读本 1–200 主题合并（2026-09-06） | 100 条过程卡并为 15 条：三回路/五对颅神经/五态梯子/神经觉/九头蛇/呼吸肩颈观察 + 病名与手法红线 | 1–200 不再拆回过程卡；动作步骤以自学手册为准；病名个案不进适应症 |
| 罗森堡读本 201–240 续拆（2026-09-06） | 20 条：偏头痛激痛点收束 + 第6章身心/焦虑/回盲瓣/家暴/PTSD | 不药而愈、内脏按摩、家暴/PTSD 不得当适应症或门店 SOP |
| 罗森堡读本 241–352 续拆完（2026-09-06） | 50 条过程卡：第6章病名专章、第7章泛自闭、第二部、附录 | 随后主题合并为 016~027 |
| 罗森堡读本 201–352 主题合并（2026-09-06） | 70 条过程卡收成 12 条：听滤/激痛点、共同调节、PTSD 分态、后半本红线、第二部目的、附录证据等级 | 保留 001~015；动作走自学手册；勿再逐页 import |
...
- [x] 罗森堡《迷走神经的自我检测与治愈》扫描件 1–200 页拆完后，按用户要求主题合并为 KP-PVB-001~015
- [x] 同书 201–352 页先拆后主题合并为 KP-PVB-016~027（70→12）；全书扫描件结束
...
- [x] 罗森堡书 1–200 并成 15 条、201–352 并成 12 条；勿再逐页 import；第二部步骤以自学手册为准
- [x] 自学手册：`docs/罗森堡腹侧检验自学流程.md`（检验 A–G + 基本动作/火蜥蜴/扭转；测了再做再测）
...
| `/open/catalog` | 来源清单：总库已合并 607，可外发 480，仅内训 127 不收录 |
...
│   ├── apply-rosenberg-vagus-merge.mjs 100→15 主题合并（保留 016 起）
│   ├── import-rosenberg-vagus-book-201-240.mjs 同书201–240页续拆
│   ├── import-rosenberg-vagus-book-241-280.mjs 同书241–280页
│   ├── import-rosenberg-vagus-book-281-320.mjs 同书281–320页第二部
│   ├── import-rosenberg-vagus-book-321-352.mjs 同书321–352页（已合并勿再跑）
│   ├── apply-rosenberg-continuation-merge.mjs 201–352 →016~027
...
| 2026-09-04 | **整合方案 v5.0**（197→229）：两份模块迁移评估过闸后并入。`PAT-MAP-008`。信噪比架构与五个申请组不变；SPA/床/冥想舱模块平移全部打掉（`072`～`077`、`065`）；打开组一 `060/061/062/066/069/071`、组三 `063/064`、组四 `067/068/070`。先案 87→97（`PAT-PRI-088`～`097`），红灯 18→25。产出 `patent-drafts/专利整合方案-v5.md` 与 docx。知识点总库 580 未改 |
...
| 2026-09-05 | 罗森堡《迷走神经的自我检测与治愈》扫描件 1–40 页精细拆分为 KP-PVB-001~020（摘要，不复述原文动作）。库 580→600。公开页 453→473，仅内训仍 127。病名个案与颅荐骨不得外推为漂浮适应症；第一部与自助动作待后续页 |
| 2026-09-06 | 同书扫描件 41–80 页 → KP-PVB-021~040。库 600→620。公开页 473→493。补九头蛇、新/老迷走器官图、金发女孩三态；症状清单与牙科个案不得当适应症。检测与动作仍待续 |
...
| 2026-09-06 | 补自学手册 `docs/罗森堡腹侧检验自学流程.md`：检验 A–G + 基本动作/火蜥蜴/扭转，测了做了再测。不是门店 SOP，不是适应症 |
| 2026-09-06 | 用户要求接着拆：同书扫描件 201–240 页 → KP-PVB-016~035。库 595→615。公开页 468→488。补偏头痛激痛点收束与第6章身心/焦虑/回盲瓣/家暴/PTSD；不药而愈、内脏按摩、家暴/PTSD/颅荐骨不得当适应症或门店 SOP。待 241 页 |
| 2026-09-06 | 同书 241–352 页拆完（用户连传三包）。KP-PVB-036~085。库 615→665。公开页 488→538。补第6章忧郁/躁郁/ADHD、第7章泛自闭与听音乐计划、第二部动作目的、注释证据等级与附录图。作者禁语「不要说能治好自闭症」入库；神经筋膜/SSP/头型手法不是门店 SOP。扫描件全书结束 |
| 2026-09-06 | 用户要求把 016~085 像 1–200 那样主题合并。70→12 为 KP-PVB-016~027。库 665→607。公开页 538→480。留下听滤/激痛点、共同调节、PTSD 分态、后半本红线、第二部目的、附录证据等级。保留 001~015。勿再逐页 import |
| 2026-09-06 | 用户要求并进 main：罗森堡全书 27 条（KP-PVB-001~027）+ 自学手册合入生产分支。公开页 `/open/vagus` |
