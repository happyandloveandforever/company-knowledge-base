...
- [ ] 氢/氧/二氧化碳微细气泡选配：按 `docs/氢氧二氧化碳微细气泡-产品研发方案.md` 做 P0 台架（清水 vs 高盐），不过关不上客舱
...
| 2026-09-05 | **产品研发（非专利）**：氢/氧/二氧化碳微细气泡接到现有舱的实施方案。文件 `docs/氢氧二氧化碳微细气泡-产品研发方案.md` + docx。不入库专利库、不改知识点。结论：外购 PEM+耐盐混合器；先清水/高盐台架；氢与臭氧互斥；2:1 氢氧只许出舱吸入 |
...
- 「处理专利库 / 把检索矩阵拆进专利库」
- 「氢氧二氧化碳微细气泡接到现有舱」（产品研发，见 `docs/氢氧二氧化碳微细气泡-产品研发方案.md`）
- 「修复 upload 页 xxx 问题」
