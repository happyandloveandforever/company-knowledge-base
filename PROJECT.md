...
| 指标 | 数值 |
|------|------|
| 知识点总数 | **665**（647 `approved` + 18 `draft`） |
| 通识层 `commons` | **199** 条：公开科学/政策/卫生/证据边界 + 迷走/VNS 通识 + NSF 标准五问 + 罗森堡读本 85 条（1–200 合并 15 + 201–352 续拆 70） |
| 公司自有层 `company` | **466** 条：产品、SOP、报价、案例、财务、内训教材、综合干预专业版、内部原子库、疗法叙事脊柱、罗森堡对接口径 |
| 用途 `usage` | `pitch` 317 · `training` 213 · `ops` 62 · `both` 73 |
| **仅内训 `internalOnly`** | **127** 条（`KP-TRN-*` 94 + `KP-ATOM-*` 20 + `KP-RX-*` 13），编排 PPT 默认排除 |
| 已导入文件 | **39** |
| 待 Claude 拆分队列 | 0 |
| 结构判断 | 两层已切开；内训 127 条；迷走三套 56 条已批准；罗森堡读本 **85 条**（001~015 为 1–200 主题合并；016~085 为 201–352 续拆，全书正文+附录已完）；原子库零件箱 20 + 疗法五维脊柱 13；NSF 标准五问 8 条通识卡。仍缺锁数字与真实案例 |
...
| 迷走神經的自我檢測與治癒_201-240.pdf | SRC-PVB-ROSENBERG-201-240 | KP-PVB-016 ~ 035 | 20 | done，已批准 | claude-agent |
| 迷走神經的自我檢測與治癒_241-280.pdf | SRC-PVB-ROSENBERG-241-280 | KP-PVB-036 ~ 055 | 20 | done，已批准 | claude-agent |
| 迷走神經的自我檢測與治癒_281-320.pdf | SRC-PVB-ROSENBERG-281-320 | KP-PVB-056 ~ 075 | 20 | done，已批准；动作不入库 SOP | claude-agent |
| 迷走神經的自我檢測與治癒_321-352.pdf | SRC-PVB-ROSENBERG-321-352 | KP-PVB-076 ~ 085 | 10 | done，已批准；全书结束 | claude-agent |
...
| 罗森堡读本 241–352 续拆完（2026-09-06） | 50 条：第6章病名专章、第7章泛自闭、第二部动作目的、注释与附录 | 自闭/忧郁/ADHD 不是适应症；基本动作/火蜥蜴/扭转走自学手册；神经筋膜与 SSP 不是门店项目 |
...
- [x] 同书 201–352 页续拆为 KP-PVB-016~085（第6–7章 + 第二部目的 + 附录；全书扫描件结束）
...
- [x] 罗森堡书 1–200 页已主题合并为 15 条；201–352 已续拆为 016~085；勿再跑 1–200 逐页 import；第二部步骤以自学手册为准
...
| `/open/catalog` | 来源清单：总库已合并 665，可外发 538，仅内训 127 不收录 |
...
│   ├── import-rosenberg-vagus-book-321-352.mjs 同书321–352页附录收尾
