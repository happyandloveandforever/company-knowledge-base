...
| 日期 | 变更 |
|------|------|
| 2026-09-06 | **分镜 003e 研究视频叠字**：把静帧上的「2010s– / 临床与影像研究 / 脑电与生理监测 / 先有研究，后发展成疗法」叠进约 5.6 秒研究原片，输出 `003e-eeg-overlay.mp4`。原片自带的 BR 与 γβθα 不再另叠。 |
| 2026-09-06 | **分镜 006b/006c 补品牌与视频位**：006b 配 i-sopod、Dreampod、Oasis、Superior、Ocean Float、Samadhi 名称排；006c 中部为用户视频首帧占位，成片在同一框换成 `chinese-float.mp4`。 |
| 2026-09-06 | **分镜 006 章末承接中式漂浮**：国际关注疼痛与睡眠 → 现有设备停在放松体验 → 中式漂浮扩大内涵/结合机理/技术升级 → 专家教授与方舟收集研究数据。 |
| 2026-09-06 | **分镜 004 重复卡改正面口径**：问「多次使用，是否舒适安全？」；大字「六次，七十五人全部完成」；绿框「依从度高，使人舒适的安全疗法」。不再上屏「人能不能做完」「不是疗效金标准」。 |
| 2026-09-06 | **分镜 004 左下文字加实底**：四张论文卡左下角改为深色底板；功效卡问句改为「用临床对照的标准看，有没有功效？」。四宫格标题改为「一次有结果，多次也显著，完成疗程无不良，长期效果仍持续。」；四张卡底部改为「先有漂浮疗法，后有中式漂浮」。 |
