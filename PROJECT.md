...
| 2026-09-05 | **壳体传声产品开发方案**（不入库专利）：`docs/舱内壳体传声-产品开发方案.md`。现有「音乐舒缓系统」是空气喇叭，戴耳塞后漂中基本无效；用舱外全频触觉换能器把舱壁当喇叭盆。写清使用者三条通路（气导被耳塞阻断、液体触觉、骨导听觉）、与深静音两档、样机 BOM、FA-D/O 安装、A–F 实验与验收。默认关。不写疗效 |
