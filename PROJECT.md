...
| 指标 | 数值 |
|------|------|
| 知识点总数 | **470**（458 `approved` + 12 `draft`） |
| 已导入文件 | **14** |
| 待 Claude 拆分队列 | 0 |
| 结构判断 | **不平衡**：论文/产品/宣传厚，经营闭环（FAQ/售后/统一口径/真实案例）薄 |
...
| 公开文献与标准摘录（Web） | SRC-WEB-ENRICH | KP-WEB-001 ~ 012 | 12 | done，**draft 待审** | 网上高价值摘录 |
...
| 已补 | 宣讲结构、失重舱谱系、消杀、实验方案、网上纠偏/卫生/政策 | 先审 `KP-WEB-*`，再决定是否再补书 |
| 过薄 | FAQ≈0、售后≈0、公司一页纸 5、运营 8、统一数字口径未锁 | **你必须提供**：机构/专利/C端锁定数字、可公开案例、售后原文 |
| 冲突 | 乳酸（SAN-003 vs MEV-021）；Feinstein 曾被标成 RCT | 对外跟 `KP-WEB-001` / `KP-WEB-006` |
...
- [ ] **审核网上补强卡 `KP-WEB-001~012`**（Feinstein 纠偏、NSF 卫生、透皮镁、健康中国、证据金字塔）
- [ ] 用户提供：可公开案例回访、售后/维保/耗材制度原文（网上补不了）
- [ ] 上传优先书籍：睡眠/REST综述/体验经济（政策语言已用公开文件补了一部分）
