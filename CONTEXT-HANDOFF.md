...
>
> 确认三件事再开始：`data/knowledge-points.json` 有 592 条、`data/patents.json` 有 231 条、`git branch` 在当前工作分支。
>
> 我现在要做的是：【在这里写你这次想干什么】
...
node -e "console.log('专利卡', require('./data/patents.json').length)"            # 应为 231
...
| **独立专利库** | `data/patents.json` | **231** | **不进 `/open`**；网页 https://company-knowledge-base-nine.vercel.app/patents |
